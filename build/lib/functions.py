...
def saveExcel(img_path,healthy_count,senescent_count,ratio,program_start_time):
    ...
    storage_df = pd.DataFrame([img_name,healthy_count,senescent_count,ratio]).transpose()
    storage_df.columns = ["Image","healthy count", "senescent count", "healthy / senescent ratio"]
...
def main_analysis(directory):
    ...
    for i,img_path in enumerate(img_paths):
        ...
        create_figure(red,red_thresholded,green,healthy_nuclei,blue,img_path
                     ,program_start_time)
        ...
        saveExcel(img_path,healthy_count,senescent_count,ratio
                 ,program_start_time)
